...
const struct instr_table INSTR_TABLE[] = {
    ...
    {"verr",        verr,        {m, NA},    M,   OTHER,          NA,  4,   4,  {REX, 0x0f, 0x00, REG}},
    {{'\0'},        verr,        {r, NA},    M,   OTHER,          NA,  4,   4,  {REX, 0x0f, 0x00, REG}},
    {"verw",        verw,        {m, NA},    M,   OTHER,          NA,  5,   4,  {REX, 0x0f, 0x00, REG}},
    {{'\0'},        verw,        {r, NA},    M,   OTHER,          NA,  5,   4,  {REX, 0x0f, 0x00, REG}},
